...
<frm:form role="form" method="POST" action="GrabarNuevo">                   
    ...
    <div class="form-group">
        <frm:label path="idSucursal.idSucursal">Cargo</frm:label>
        <frm:select class="form-control" path="idCargo.idCargo">
		    <frm:options items="${listaCar}" itemValue="idCargo" itemLabel="nombre"></frm:options>
        </frm:select>
    </div>      
    <div class="form-group">
        <frm:label path="idSucursal.idSucursal">Sucursal</frm:label>
        <frm:select class="form-control" path="idSucursal.idSucursal">
		    <frm:options items="${listaSuc}" itemValue="idSucursal" itemLabel="nombre"></frm:options>
        </frm:select>
    </div>
    ...
    <button type="button" class="btn btn-warning btn-circle btn-xl"><i class="fa fa-list"></i></button>
    </a>
